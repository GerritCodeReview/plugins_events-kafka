...
import static com.googlesource.gerrit.plugins.kafka.config.KafkaProperties.SEND_STREAM_EVENTS_CONFIG_FIELD;
...
import static com.googlesource.gerrit.plugins.kafka.config.KafkaSubscriberProperties.GROUP_ID_FIELD;
import static com.googlesource.gerrit.plugins.kafka.config.KafkaSubscriberProperties.POLLING_INTERVAL_FIELD;
...
public class InitConfig implements InitStep {
  ...
  public void run() throws Exception {
    ...
    pluginSection.set(SEND_STREAM_EVENTS_CONFIG_FIELD, Boolean.toString(sendStreamEvents));
